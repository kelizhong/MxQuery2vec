...
class Seq2seqDataManager(object):
    def __init__(self, data_dir, vocabulary_path, action_patterns, batch_size, buckets, ip='127.0.0.1',
    ...
    def start_data_stream_process(self):
        for action_pattern, floor in self.action_patterns:
            p = Seq2seqDataVentilatorProcess(action_pattern, self.data_dir, self.vocabulary_path, self.batch_size,
