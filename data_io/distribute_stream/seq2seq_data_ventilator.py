...
class Seq2seqDataVentilatorProcess(Process):
    def __init__(self, action_pattern, data_dir, vocabulary_path, top_words, batch_size, buckets, sample_floor=-1, num_epoch=65535, ip='127.0.0.1', port='5555', name='VentilatorProcess'):
    ...
    def get_data_stream(self):
        ...
        data_stream = Seq2seqAksisDataStream(action_add_files, self.vocabulary,
                              self.vocabulary, self.buckets, self.batch_size, sample_floor=self.sample_floor)
        return data_stream
