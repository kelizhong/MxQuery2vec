...
def add_fit_args(parser):
    ...
    parser.add_argument('--monitor', dest='monitor', type=int, default=0,
                        help='logs network parameters every N iters if larger than 0')
...
def fit(args, network, train, **kwargs):
    """
    train a model
    ...
    # create model
    model = mx.mod.BucketingModule(network, default_bucket_key=train.default_bucket_key, context=devs)
